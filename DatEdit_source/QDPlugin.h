...
struct MPQDRAFTPLUGINMODULED;

/*
	MPQDRAFTPLUGIN
*/
#include <pshpack1.h>
struct MPQDRAFTPLUGIN
{
	HMODULE hQDP;
	IMPQDraftPlugin * lpIMPQDraftPlugin;
	DWORD dwComponentID;
	char szMPQDraftPlugin[MPQDRAFT_MAX_PATH];
	char szMPQDraftPluginName[MPQDRAFT_MAX_PLUGIN_NAME];
	MPQDRAFTPLUGINMODULE * lpPluginModules;
	MPQDRAFTPLUGINMODULED * lpPluginModulesData;
	DWORD dwPluginModules;
	BOOL fIsConfigured;
	DWORD dwSize;
	DWORD dwSizeComp;
	BYTE * lpData;
...
*/
typedef BOOL (WINAPI * GetMPQDraftPlugin_)(IMPQDraftPlugin **lppMPQDraftPlugin);
